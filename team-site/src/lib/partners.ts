...
export const PARTNERS: Partner[] = [
  {
    name: "Kementerian Koordinator Bidang Perekonomian Republik Indonesia",
    alt: "Logo Kementerian Koordinator Bidang Perekonomian Republik Indonesia",
    src: "/brand/kemenko-perekonomian.png",
    href: "https://www.ekon.go.id/",
    width: 50,
    height: 54,
